...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.updateProyecto', ['ProyectoID' => $proyecto->ProyectoID]) }}" method="POST">
            ...
            <div class="form-group">
                <label for="NombreAsignado">Nombre del Profesor Asignado:</label>
                <input type="text" class="form-control" id="NombreAsignado" name="NombreAsignado" value="{{ $proyecto->NombreAsignado }}" required>
            </div>
        
            <div class="form-group">
                <label for="ApellidoAsignado">Apellido del Profesor Asignado:</label>
            ...
            <div class="form-group">
                <label for="CorreoProfeAsignado">Correo Electrónico del Profesor Asignado:</label>
