            ...
            <div class="sidebar-links">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="practicasDropdown">
                        <a class="dropdown-item" href="{{ route('admin.agregarEmpresa') }}"><i
                                class="material-icons">add_business</i> Agregar-Empresa</a>
                        <a class="dropdown-item" href="{{ route('admin.aceptarFaseI') }}"><i
                                class="material-icons">check_circle</i> Aprobar-Practicas</a>
                    </div>
                </div>
